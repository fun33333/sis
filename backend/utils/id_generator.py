...
class IDGenerator:
    ...
    @staticmethod
    def generate_employee_code(campus_code, shift, year, role, entity_id):
        """Generate employee code: C03-A-25-T-001"""
    ...
    @staticmethod
    def get_next_employee_number(campus_code, shift, year, role):
    ...
    def generate_unique_employee_code(campus, shift, year, role):
        ...
        try:
            ...
            next_number = IDGenerator.get_next_employee_number(campus_code, shift, year, role)
